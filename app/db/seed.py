...
def seed_database(db: Session):
    ...
    work_order1 = WorkOrder(
        customer_id=customer1.id,  # ADD THIS
    ...
    work_order3 = WorkOrder(
        customer_id=customer2.id,  # ADD THIS
    ...
    print("  Customer:   john@test.com / password123 (6 work orders)")
    print("  Customer:   jane@test.com / password123 (1 work order)")
